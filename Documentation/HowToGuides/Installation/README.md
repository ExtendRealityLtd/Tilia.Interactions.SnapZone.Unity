...
The `Interactions.SnapZone` prefab provides a way of specifying a spatial point to snap an Interactable to when it is dropped and can be included in a [Unity] software project via the [Unity Package Manager].
...
* Adjust the [project manifest file][Project-Manifest] `manifest.json` in a text editor.
  ...
  * Add `io.extendreality.tilia.interactions.snapzone.unity` to `dependencies`, stating the latest version.
  ...
  ```json
  {
    ...
    "dependencies": {
      "io.extendreality.tilia.interactions.snapzone.unity": "X.Y.Z",
      ...
    }
  }
  ```
...
The `Tilia Interactions SnapZone Unity` package will now be available in your Unity project `Packages` directory ready for use in your project.
